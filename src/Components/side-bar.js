class Sidebar extends HTMLElement {
    ...
    render() {
        ...
        <div>
            ...
            <div class="absolute top-0 left-0 h-screen w-[60vw] xl:w-[34vw] transform -translate-x-full z-30 bg-[#1E213A] p-8 transition-all duration-500" id="sidebar">
                <div class="text-white flex justify-end" id="close-sidebar">
